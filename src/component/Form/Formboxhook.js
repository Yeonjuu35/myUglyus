                ...
                <ul>
                    <li className="mb-lg-3 mb-2">
                        <Forminput
                            ...
                            labelcls="form-label formfontText mb-1"
                            inputcls="form-control formfontPlacehold inputboxType1 px-0 ps-2"
                            errors={errors}
                        />
                    </li>
                    <li className="mb-lg-3 mb-2">
                        <Contactinput
                            ...
                            labelnm="formhp"
                            labelcls="form-label formfontText mb-1"
                            inputcls="form-input formfontPlacehold inputboxType2 px-0 ps-2"
                            register={register}
                            errors={errors}
                        />
                    </li>
                    ...
                    <li className="d-flex formfontText mt-lg-4 mt-3 form-check justify-content-center align-items-center ps-0">
                    ...
                    <li className="d-flex justify-content-center">
                        {errors.agree && <span className="formfontText text-danger">개인정보 수집 및 이용에 동의해야 합니다.</span>}
                    </li>
                    <li className="mx-auto">
                        <button type="submit" className="formbuttonStyle mt-lg-4 mt-3">문의하기</button>
                    </li>
                </ul>
            </form>
            ...
            {showPopup && (
                <div className="popup-overlay">
                    <div className="popup-content d-flex flex-column justify-content-lg-end justify-content-center align-items-center py-lg-4 py-3">
                        <p className="fontFormboxTitle text-center p-2 m-0 text-nowrap mb-lg-2 mb-0">신청해주셔서 감사합니다!
                            <span className="d-block formfontPopup mt-lg-1 mt-0">확인 후 최대한 빠르게 연락드리겠습니다.</span>
                        </p>
